            ...
            <div class="container" style="margin-right: 0;margin-left: 0;width: 100%;padding-right: 0;padding-left: 0;max-width: 100%;">
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" data-bs-parallax-bg="true" style="background-image: url(./images/hd/senna.png);width: 100%; height: 600px;background-position: center;background-size: cover;">
                        </div>
                        ...
                        <div class="swiper-slide" data-bs-parallax-bg="true" style="background-image: url(./images/hd/lamboMain3.png);width: 100%; height: 600px;background-position: center;background-size: cover;">
                        </div>
                ...
                <div class="intro">
                    <h2 class="text-center">SNEAK PEEK</h2>
