    ...
    <div class="auth">
        ...
        <div id="register" class="auth-container">
                ...
                <form action="RegisterProcess.php" method="post">
                    ...
                    <input aria-label="re-enter password" type="password" class="inputs" required placeholder="Re-enter Password" name="password_confirm" minlength="8" maxlength="20" pattern="[a-zA-Z0-9]+"/><br>
